      ...
      <div className="rightpage-panel">
        <div className="rightpage-header">
          <div>
            ...
            <h2>
              Round {data?.currentRound || 1} / {TOTAL_GAME_ROUNDS}
            </h2>
          </div>
        ...
        <div className="rightpage-actions">
          <button
            ...
            disabled={
              !isAlive || data?.gameState !== "playing" || isCodeReviewPending
            }
          >
            Emergency Meeting
          </button>
        ...
        {isCodeReviewPending && (
          <div className="review-panel">
            <p className="review-text">
              {data?.codeRunReason || "Running code..."}
            </p>

            {isCodeReviewPending && <Loader message="Compiling code........" />}
          </div>
        )}
